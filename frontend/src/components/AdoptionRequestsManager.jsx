                                ...
                                <tr key={req.id}>
                                    ...
                                    <td>
                                        <div className="action-buttons">
                                            ...
                                            {req.status === 'Pending' && (
                                                <>
                                                    <button className="btn-icon approve" onClick={() => handleAction(req.id, 'approve')} title="Approve"><FaCheck /></button>
                                                    <button className="btn-icon reject" onClick={() => handleAction(req.id, 'reject')} title="Reject"><FaTimes /></button>
                                                </>
                                            )}
                                        </div>
                                    </td>
