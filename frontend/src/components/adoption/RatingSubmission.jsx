...
const RatingSubmission = ({ onSubmit, onClose, ngoName, ngoId, userName }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setSubmitting(true);
        try {
            const res = await api.post('/reviews', { ngoId, rating, comment });
            const reviewData = res.data?.data || { rating, comment, date: new Date().toISOString(), user: userName || 'Anonymous' };
